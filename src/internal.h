...
struct _GLFWwindow
{
    ...
    GLFWbool customTitlebar; // Whether custom title bar colors are enabled
    int titlebarColor;       // Title bar background color (0xRRGGBB format)
    int titlebarTextColor;   // Title bar text color (0xRRGGBB format)
...
struct _GLFWplatform
{
    ...
    void (*setWindowTitleBarColor)(_GLFWwindow *, int);
    void (*setWindowTitleBarTextColor)(_GLFWwindow *, int);
